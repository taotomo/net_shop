...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/shops-create.css') }}">
@endpush
        ...
        <div class="card">
            ...
            <form action="{{ route('shops.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>ショップ名</label>
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="例）山田商店"
                ...
                <div class="form-group">
                    <label>説明</label>
                    <textarea name="description" placeholder="ショップの説明を入力してください"
